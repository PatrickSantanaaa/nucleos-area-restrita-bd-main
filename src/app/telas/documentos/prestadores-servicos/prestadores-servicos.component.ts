...
@Component({
  selector: 'app-prestadores-servicos',
  templateUrl: './prestadores-servicos.component.html',
  styleUrls: ['./prestadores-servicos.component.scss']
})
export class PrestadoresServicosComponent {
  messages: Message[] = [
    {
      severity: 'info',
      summary: 'Informe',
  ...
  constructor(private service: PrestadoresServicosService){}
